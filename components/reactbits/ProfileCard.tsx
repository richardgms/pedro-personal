...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const handlePointerMove = useCallback(
    (event: PointerEvent) => {
      ...
      if (now - lastMoveRef.current < 33) return // ~30fps
          ...
          <div className="pc-content pc-avatar-content">
            ...
            {showUserInfo && (
              <div className="pc-user-info">
                ...
                <button className="pc-contact-btn" onClick={handleContactClick} style={{ pointerEvents: 'auto' }} type="button" aria-label={`Contact ${name}`}>
                  {contactText}
                </button>
              </div>
            )}
